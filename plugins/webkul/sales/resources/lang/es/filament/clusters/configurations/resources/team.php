...
return [
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'force-delete' => [
                'notification' => [
                    'title' => 'Equipo de ventas eliminado forzosamente',
                    'body'  => 'El equipo de ventas se ha eliminado forzosamente correctamente.',
                ],
            ],
        ],
        ...
        'bulk-actions' => [
            ...
            'force-delete' => [
                'notification' => [
                    'title' => 'Equipos de ventas eliminados forzosamente',
                    'body'  => 'Los equipos de ventas se han eliminado forzosamente correctamente.',
                ],
            ],
        ],
